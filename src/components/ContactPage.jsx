...
import mandalaTopRight from '../assets/images/mandala-top-right.png'
import mandalaBottomLeft from '../assets/images/mandala-bottom-left.png'
  ...
  return (
    <section id="contact" className="contact-section">
      ...
      <div className="mandala-pattern mandala-top-right">
        <img src={mandalaTopRight} alt="" className="mandala-image" />
      </div>
      <div className="mandala-pattern mandala-bottom-left">
        <img src={mandalaBottomLeft} alt="" className="mandala-image" />
      </div>
    </section>
