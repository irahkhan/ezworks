import mandala from '../assets/images/mandala-home.png'
        ...
        <div className="home-left-section">
          <div className="home-logo-wrapper">
            <div className="home-mandala">
              <img src={mandala} alt="" className="home-mandala-image" />
            </div>
            <div className="home-logo">
              <img src={homeLogo} alt="Films Logo" className="home-logo-image" />
            </div>
          </div>
        </div>
